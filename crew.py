...
class Crew(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.api_base_url = "https://socialclub.rockstargames.com/crewsapi/SearchCrews"
    ...
    async def crew_info(self, interaction: discord.Interaction, crew_name: str):
        ...
        try:
            ...
            async with aiohttp.ClientSession() as session:
                async with session.get(self.api_base_url, params=params) as resp:
                    if resp.status != 200:
